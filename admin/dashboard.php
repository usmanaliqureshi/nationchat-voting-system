  ...
  <body>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Dashboard</h1>
			<p>Welcome <?php echo $_SESSION['username']; ?>, this is the first version of voting system for our irc network NationCHAT. If you have any ideas or suggestions about it please share them with us.</p>
